// app/(Transactions)/[customer_name]/_layout.tsx
  ...
  return (
    ...
    >
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <Ionicons name="receipt-outline" size={size ?? ICON_SIZE} color={color} />
          ),
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Transactions',
          // 👇 remove the 'auto' margin — it doesn't work on RN
          tabBarIcon: ({ color, size }) => (
            <Ionicons name="swap-horizontal-outline" size={size ?? ICON_SIZE} color={color} />
          ),
        }}
      />
    </Tabs>
