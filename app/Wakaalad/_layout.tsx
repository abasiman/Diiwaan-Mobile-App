...
<Tabs.Screen
  name="wakaaladmovement"
  options={{
    title: 'oil movements',
    tabBarIcon: ({ color, size }) => (
      <Ionicons name="swap-vertical" size={size ?? ICON_SIZE} color={color} />
      // If your Ionicons version doesn’t have "swap-vertical", use "repeat-outline"
      // <Ionicons name="repeat-outline" size={size ?? ICON_SIZE} color={color} />
    ),
  }}
/>
